...
Some containers have to rebind their allocators twice.
But the rebind type are not exposed to the user.
Possible solution: Look the implentation and find
out one type is pointer and one is node. Or expose
the node type.

Implementations can now specialize their allocator
to the node type. But ...
