...
std::unordered_set<int> obj(alloc);
...
Node customization of the pointer type.
\end{block}
\begin{lstlisting}
template <class T>
struct node {
...
\item The allocator type need the node type.
...
\begin{lstlisting}
// We know node types and can put them in the stack.
...
l1 = {27, 1, 60};
\end{lstlisting}
\begin{block}{Let us move to more interesting use cases}
\end{block}
\end{frame}
