...
\tikzstyle{marrow}=[very thick,-, color=memC]
...
\begin{tikzpicture}[scale=1.0, rounded corners]
   ...
   \uncover<5-> {
      \marrow (node6.south) -- (2.5, 3.0) -- (node7.north);
...
\begin{tikzpicture}[scale=1.0, rounded corners]
      ...
      \mbu (node0) at  (0.25,4.0) {};
      \mbu (node1) [right=of node0] {};
      \mbu (node2) [right=of node1] {};
      \mbu (node3) [right=of node2] {};
      \mbu (node4) [right=of node3] {};
      \mbu (node5) [right=of node4] {};
      \mbu (node6) [right=of node5] {};
      \mbu (node7) [right=of node6] {};
      \mbu (node8) [right=of node7] {};
      \mbu (node9) [right=of node8] {};

      \mbu (node10) [right=of node9] {};
      \mbu (node11) [right=of node10] {};
      \mbu (node12) [right=of node11] {};
      \mbu (node13) [right=of node12] {};
      \mbu (node14) [right=of node13] {};
      \mbu (node15) [right=of node14] {};
      \mbu (node16) [right=of node15] {};
      \mbu (node17) [right=of node16] {};
      \mbu (node18) [right=of node17] {};
      \mbu (node19) [right=of node18] {};

      \mbu (node20) [right=of node19] {};
      \mbu (node21) [right=of node20] {};
      \mbu (node22) [right=of node21] {};
      \mbu (node23) [right=of node22] {};
      \mbu (node24) [right=of node23] {};
      \mbu (node25) [right=of node24] {};
      \mbu (node26) [right=of node25] {};
      \mbu (node27) [right=of node26] {};
      \mbu (node28) [right=of node27] {};
      ...
      \marrow (node4.north) to [bend right=-65] (node5.north);
      \marrow (node5.north) to [bend right=-65] (node6.north);
      \marrow (node6.north) to [bend right=-65] (node7.north);
      \marrow (node7.north) to [bend right=-65] (node8.north);
      \marrow (node8.north) to [bend right=-65] (node9.north);
      ...
      \marrow (node13.north) to [bend right=-65] (node14.north);
      \marrow (node14.north) to [bend right=-65] (node15.north);
      \marrow (node15.north) to [bend right=-65] (node16.north);
      \marrow (node16.north) to [bend right=-65] (node17.north);
      \marrow (node17.north) to [bend right=-65] (node18.north);
      \marrow (node18.north) to [bend right=-65] (node19.north);

      \marrow (node19.north) to [bend right=-65] (node20.north);
      \marrow (node20.north) to [bend right=-65] (node21.north);
      \marrow (node21.north) to [bend right=-65] (node22.north);
      \marrow (node22.north) to [bend right=-65] (node23.north);
      \marrow (node23.north) to [bend right=-65] (node24.north);
      \marrow (node24.north) to [bend right=-65] (node25.north);
      \marrow (node25.north) to [bend right=-65] (node26.north);
      \marrow (node26.north) to [bend right=-65] (node27.north);
      \marrow (node27.north) to [bend right=-65] (node28.north);

      % next
      \mbd (Unode0) at  (0.5,2.0) {};
      \mbd (Unode1)  [right=of Unode0] {};
      \mbd (Unode2)  [right=of Unode1] {};
      \mbd (Unode3)  [right=of Unode2] {};
      \mbd (Unode4)  [right=of Unode3] {};
      \mbd (Unode5)  [right=of Unode4] {};
      \mbd (Unode6)  [right=of Unode5] {};
      \mbd (Unode7)  [right=of Unode6] {};
      \mbd (Unode8)  [right=of Unode7] {};
      \mbd (Unode9)  [right=of Unode8] {};
      \mbd (Unode10) [right=of Unode9] {};
      \mbd (Unode11) [right=of Unode10] {};
      \mbd (Unode12) [right=of Unode11] {};
      \mbd (Unode13) [right=of Unode12] {};
      \mbd (Unode14) [right=of Unode13] {};
      ...
      \marrow (Unode13.north) to [bend right=-65] (Unode14.north);
      % next
      \mbq (Qnode0) at  (1.0,0.0) {};
      \mbq (Qnode1)  [right=of Qnode0] {};
      \mbq (Qnode2)  [right=of Qnode1] {};
      \mbq (Qnode3)  [right=of Qnode2] {};
      \mbq (Qnode4)  [right=of Qnode3] {};
      \mbq (Qnode5)  [right=of Qnode4] {};
      \mbq (Qnode6)  [right=of Qnode5] {};
      ...
      % next
      \mbo (Onode0) at  (2.0,-2.0) {};
      \mbo (Onode1)  [right=of Onode0] {};
      \mbo (Onode2)  [right=of Onode1] {};
      \mbo (Onode3)  [right=of Onode2] {};

      \marrow (Onode0.north) to [bend right=-65] (Onode1.north);
      \marrow (Onode1.north) to [bend right=-65] (Onode2.north);
      \marrow (Onode2.north) to [bend right=-65] (Onode3.north);
...
\begin{tikzpicture}[scale=1.0, rounded corners]
   ...
   \uncover<3-> {
      \mbq (nextq) at (1,3) {Next};
      \ebq (valueq) [right=of nextq] {Value};
   }
   \uncover<4-> {
      \mbo (nexto) at (2,2) {Next};
...
\begin{tikzpicture}[scale=1.0, rounded corners]
   ...
   \uncover<1> {
      \mbq (node0) at (-5.0,4) {Block$_0$};
      \mbq (node1) at (-3.0,4) {Block$_1$};
      \mbq (node2) at (-1.0,4) {Block$_2$};
      \mbq (node3) at (1.0,4) {Block$_3$};
      \mbq (node4) at (3.0,4) {Block$_4$};
      \mbq (node5) at (5.0,4) {Block$_5$};
      \mbq (node6) at (7.0,4) {Block$_6$};
      \mbq (node7) at (-5.0,2) {Block$_{7}$};
      \mbq (node8) at (-3.0,2) {Block$_{8}$};
      \mbq (node9) at (-1.0,2) {Block$_{9}$};
      \mbq (node10) at ( 1.0,2) {Block$_{10}$};
      \mbq (node11) at ( 3.0,2) {Block$_{11}$};
      \mbq (node12) at ( 5.0,2) {Block$_{12}$};
      \mbq (node13) at ( 7.0,2) {Block$_{13}$};

      \draw[very thick,<-, densely dotted, rounded corners=10pt,color=black] (node0.north) -- (-4,4.7) -- (node1.north);
      \draw[very thick,<-, densely dotted, rounded corners=10pt,color=black] (node1.north) -- (-2,4.7) -- (node2.north);
      \draw[very thick,<-, densely dotted, rounded corners=10pt,color=black] (node2.north) -- ( 0,4.7) -- (node3.north);
      \draw[very thick,<-, densely dotted, rounded corners=10pt,color=black] (node3.north) -- ( 2,4.7) -- (node4.north);
      \draw[very thick,<-, densely dotted, rounded corners=10pt,color=black] (node4.north) -- ( 4,4.7) -- (node5.north);
      \draw[very thick,<-, densely dotted, rounded corners=10pt,color=black] (node5.north) -- ( 6,4.7) -- (node6.north);


      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node6.south) --  (-4,3) --  (node7.north);
      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node7.north) --  (-4,2.7) -- (node8.north);
      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node8.north) --  (-2,2.7) -- (node9.north);
      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node9.north) --  ( 0,2.7) -- (node10.north);
      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node10.north) -- ( 2,2.7) -- (node11.north);
      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node11.north) -- ( 4,2.7) -- (node12.north);
      \draw[very thick,<-,densely dotted, rounded corners=10pt,color=black] (node12.north) -- ( 6,2.7) -- (node13.north);
   }

   \uncover<2-> {
      \ebq (node0) at (-5.0,4) {Node$_0$};
      \ebq (node1) at (-3.0,4) {Node$_1$};
      \mbq (node2) at (-1.0,4) {Block$_2$};
      \ebq (node3) at (1.0,4) {Node$_3$};
      \mbq (node4) at (3.0,4) {Block$_4$};
      \ebq (node5) at (5.0,4) {Node$_5$};
      \mbq (node6) at (7.0,4) {Block$_6$};
      \mbq (node7) at (-5.0,2) {Block$_{7}$};
      \ebq (node8) at (-3.0,2) {Node$_{8}$};
      \mbq (node9) at (-1.0,2) {Block$_{9}$};
      \ebq (node10) at ( 1.0,2) {Node$_{10}$};
      \mbq (node11) at ( 3.0,2) {Block$_{11}$};
      \mbq (node12) at ( 5.0,2) {Block$_{12}$};
      \ebq (node13) at ( 7.0,2) {Node$_{13}$};
   }
   ...
   \uncover<2> {
      \draw[very thick,->,densely dotted, rounded corners=10pt,color=black] (node2.north) -- (3,4.7) -- (node6.north);
      \draw[very thick,->,densely dotted, rounded corners=10pt,color=black] (node6.south) -- (5,3) -- (node4.south);
      \draw[very thick,->,densely dotted, rounded corners=10pt,color=black] (node4.south) -- (node11.north);
      \draw[very thick,->,densely dotted, rounded corners=10pt,color=black] (node11.north) -- (1,3)-- (node9.north);
      \draw[very thick,->,densely dotted, rounded corners=10pt,color=black] (node7.south) -- (0,1.3)-- (node12.south);
      \draw[very thick,->,densely dotted, rounded corners=10pt,color=black] (node12.north) -- (node2.south);
   }
...
%
%   \uncover<1-> {
%      \mbu (next) at (0.25,5) {N};
%      \ebu (value) at (0.77,5) {V};
%   }
%
%   \uncover<2-> {
%      \mbd (next) at (0.5,4) {Next};
%      \ebd (value) at (1.6,4) {Value};
%   }
%
%   \uncover<3-> {
%      \mbq (next) at (1,3) {Next};
%      \ebq (value) at (3,3) {Value};
%   }
%   \uncover<4-> {
%      \mbo (next) at (2,2) {Next};
%      \ebo (value) at (6,2) {Value};
%   }
%\end{tikzpicture}
%
%\end{frame}
