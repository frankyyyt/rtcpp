...
\colorlet{zeroed}{orange!50!black}
\colorlet{dgfile}{red!80!black}
\tikzstyle{dgfile}=[draw,fill=dgfile,shape=rectangle,minimum width=2cm,inner sep=1ex]
\tikzstyle{zeroed}=[draw,fill=zeroed,shape=rectangle,minimum width=2cm,inner sep=1ex]
\def\dgfile{\node[style=dgfile]}
\def\zeroed{\node[style=zeroed]}
...
\begin{tikzpicture}[scale=1.0, rounded corners]
   ...
   \uncover<2-> {
      \draw[thick,->,rounded corners=10pt,color=black] (node0.north) -- (-4,5) -- (node1.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node1.north) -- (-2,5) -- (node2.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node2.north) -- ( 0,5) -- (node3.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node3.north) -- ( 2,5) -- (node4.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node4.north) -- ( 4,5) -- (node5.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node5.north) -- ( 6,5) -- (node6.north);
%      \draw[thick,->,rounded corners=10pt,color=black] (node5.north) -- (-2,4.5) -- (node6.north);
   }

   \uncover<3-> {

      \dgfile (node7) at (-5.0,0) {Node$_{7}$};
      \dgfile (node8) at (-3.0,0) {Node$_{8}$};
      \dgfile (node9) at (-1.0,0) {Node$_{9}$};
      \dgfile (node10) at ( 1.0,0) {Node$_{10}$};
      \dgfile (node11) at ( 3.0,0) {Node$_{11}$};
      \dgfile (node12) at ( 5.0,0) {Node$_{12}$};
      \dgfile (node13) at ( 7.0,0) {Node$_{13}$};
   }

   \uncover<4-> {

      \draw[thick,->,rounded corners=10pt,color=black] (node6.south) -- (-4,2) --  (node7.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node7.north) --  (-4,1) -- (node8.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node8.north) --  (-2,1) -- (node9.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node9.north) --  ( 0,1) -- (node10.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node10.north) -- ( 2,1) -- (node11.north);
      \draw[thick,->,rounded corners=10pt,color=black] (node11.north) -- ( 4,1) -- (node12.north);
   }
\end{tikzpicture}
...
%\subsection[Eldorado]{Eldorado Research institute}
%
%\begin{frame}{Eldorado Institute (Campinas)}
%    \begin{columns}
%        \begin{column}{0.5\textwidth}
%
%        \end{column}
