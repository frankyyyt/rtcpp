...
\fill[blue!50!black]  (0cm,0cm) -- (0cm, 2cm) arc (90:270:2cm) -- cycle;
\fill[red!50!black]   (0cm,0cm) -- (0cm,-2cm) arc (270:360:2cm) -- cycle;
\fill[green!50!black] (0cm,0cm) -- (2cm, 0cm) arc (0:90:2cm) -- cycle;
\end{tikzpicture}
