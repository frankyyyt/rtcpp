...
\filldraw[arraycontc] (-2cm,0.50cm) circle (0.08cm) node[right] {\color{black} Bsc Physics};
\filldraw[bothcontc] (-2cm,-0.00cm) circle (0.08cm) node[right] {\color{black} Msc Physics - gravitation};
\filldraw[nodecontc] (-2cm,-0.50cm) circle (0.08cm) node[right] {\color{black} PhD Astrophisics};
\end{tikzpicture}
\end{column}
\end{columns}
\end{frame}
