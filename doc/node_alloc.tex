...
\fill[blue!50!black]  (180:2.5cm) -- (180: 3cm) arc (180:360:3cm) -- (360:2.5cm) arc (360:180:2.5cm);
\fill[red!50!black]   (30:2.5cm) -- (30:3cm) arc (30:180:3cm)  -- (180:2.5cm) arc (180:30:2.5cm);
\fill[green!50!black] (0:2.5cm) -- (0:3cm) arc (0:30:3cm) -- (30:2.5cm) arc (30:0:2.5cm);

\filldraw[blue!50!black] (-2cm,0.5cm) circle (0.08cm) node[right] {\color{black}Only node allocation};
\filldraw[green!50!black] (-2cm,0.0cm) circle (0.08cm) node[right] {\color{black}Only array allocation};
\filldraw[red!50!black] (-2cm,-0.5cm) circle (0.08cm) node[right] {\color{black}Both};
\end{tikzpicture}
...
%____________________________________________________________
\begin{frame}[t]{Illustration}
{How node allocation is implemented in practice}
\begin{block} {Procedure}
\begin{enumerate}
\item<alert@2> Get a block of memory with $N$ nodes at once.
